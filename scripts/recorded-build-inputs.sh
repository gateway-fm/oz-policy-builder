...
# hash under CLI 27.0.0 is `5b9374d8…` (2026-08-18, after the installation-lifecycle emission
# landed); it is not comparable with the 27.1.0 value above, because the source changed in
# between.
#
