...
artifact "05-policy/" "a complete standalone Stellar contract crate: src/lib.rs, Cargo.toml, the pinned Cargo.lock and rust-toolchain.toml, the unoptimised .wasm, and build-manifest.json. Nothing here was hand-edited."
