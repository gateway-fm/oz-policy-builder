...
# Codegen writes a complete, standalone Stellar contract crate — source, manifest, pinned lockfile and
...
artifact "05-policy/" "a complete standalone Stellar contract crate: src/lib.rs and src/contract.rs, Cargo.toml, the pinned Cargo.lock, rust-toolchain.toml and rustfmt.toml, the unoptimised .wasm, and build-manifest.json. Nothing here was hand-edited."
